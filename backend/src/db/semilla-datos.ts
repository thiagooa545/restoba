...
export const RESTAURANTES: SemillaRestaurante[] = [
  {
    ...
    carta: [
      ...
      { categoria: 'Bebidas', nombre: 'Vino de la casa (copa)', descripcion: 'Malbec o torrontés, de bodega familiar mendocina.', precio: 4200, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Agua con o sin gas', descripcion: 'Botella de 500 ml.', precio: 2400, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Gaseosa línea cola', descripcion: 'Botella de 500 ml.', precio: 2900, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Café cortado', descripcion: 'Para cerrar la mesa.', precio: 2600, vegetariano: true, sinTacc: true },
    ],
  },
  {
  ...
  },
  {
    ...
    carta: [
      ...
      { categoria: 'Bebidas', nombre: 'Jarra de vino de la casa', descripcion: 'Medio litro, tinto joven.', precio: 6800, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Cerveza tirada (pinta)', descripcion: 'Rubia de barril, bien fría.', precio: 4600, vegetariano: true },
      { categoria: 'Bebidas', nombre: 'Soda (sifón)', descripcion: 'El sifón de siempre, para la mesa.', precio: 2200, vegetariano: true, sinTacc: true },
    ],
  },
  {
    nombre: 'Doña Petrona',
  ...
  },
  {
    ...
    horarios: corrido,
    carta: [
      { categoria: 'Desayunos', nombre: 'Porridge de avena', descripcion: 'Con banana, manzana asada y semillas.', precio: 7200, vegetariano: true },
      { categoria: 'Desayunos', nombre: 'Tostada de palta', descripcion: 'Pan de masa madre, palta, limón y semillas de sésamo.', precio: 8400, vegetariano: true },
      { categoria: 'Desayunos', nombre: 'Yogur con granola casera', descripcion: 'Granola tostada en el día, con miel.', precio: 6100, vegetariano: true },
      { categoria: 'Platos', nombre: 'Bowl de estación', descripcion: 'Cambia cada semana según lo que haya en la verdulería.', precio: 13400, vegetariano: true, destacado: true },
      { categoria: 'Platos', nombre: 'Tarta de puerro y ricota', descripcion: 'Masa integral hecha en casa.', precio: 10800, vegetariano: true },
      { categoria: 'Platos', nombre: 'Milanesa de berenjena', descripcion: 'Empanada con panko, con ensalada de estación.', precio: 11900, vegetariano: true },
      { categoria: 'Cafetería', nombre: 'Flat white', descripcion: 'Blend de la casa, tueste medio.', precio: 4200, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Latte de especias', descripcion: 'Canela, jengibre y cardamomo. Con leche de almendras si querés.', precio: 4900, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Espresso', descripcion: 'Simple o doble.', precio: 2800, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Licuado verde', descripcion: 'Espinaca, manzana, jengibre y limón.', precio: 5200, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Licuado de banana y cacao', descripcion: 'Con leche vegetal.', precio: 5400, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Limonada con menta y jengibre', descripcion: 'Jarra de un litro para compartir.', precio: 6300, vegetariano: true, sinTacc: true },
    ],
  },
  {
  ...
  },
  {
    ...
    horarios: corrido,
    carta: [
      { categoria: 'Desayunos', nombre: 'Café con leche y tres medialunas', descripcion: 'Las medialunas salen del horno a las siete de la mañana.', precio: 5600, vegetariano: true, destacado: true },
      { categoria: 'Desayunos', nombre: 'Tostadas con manteca y mermelada', descripcion: 'Pan de campo tostado, manteca de estancia y mermelada casera.', precio: 4900, vegetariano: true },
      { categoria: 'Desayunos', nombre: 'Medialunas de manteca (3 unidades)', descripcion: 'De la panadería de la esquina, todavía tibias.', precio: 3200, vegetariano: true },
      { categoria: 'Desayunos', nombre: 'Tostado de jamón y queso', descripcion: 'En pan de miga, prensado a la plancha.', precio: 6900 },
      { categoria: 'Desayunos', nombre: 'Budín de limón casero', descripcion: 'Porción generosa, con glaseado.', precio: 4100, vegetariano: true },
      { categoria: 'Cafetería', nombre: 'Café con leche', descripcion: 'Blend de la casa, tueste medio.', precio: 3400, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Cortado', descripcion: 'En taza chica, como corresponde.', precio: 2900, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Lágrima', descripcion: 'Mucha leche y una lágrima de café.', precio: 2900, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Flat white', descripcion: 'Doble espresso y leche texturizada.', precio: 4200, vegetariano: true, sinTacc: true },
      { categoria: 'Cafetería', nombre: 'Submarino', descripcion: 'Leche caliente y una barra de chocolate para hundir.', precio: 4600, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Licuado de banana', descripcion: 'Con leche o con agua, como prefieras.', precio: 4300, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Licuado de frutilla', descripcion: 'Solo cuando hay frutilla de estación.', precio: 4500, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Exprimido de naranja', descripcion: 'Medio litro, exprimido al momento.', precio: 4800, vegetariano: true, sinTacc: true },
      { categoria: 'Bebidas', nombre: 'Agua saborizada', descripcion: 'Pomelo o manzana.', precio: 2600, vegetariano: true, sinTacc: true },
    ],
  },
  {
